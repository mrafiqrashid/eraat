...
<div class="row">
    <div class="col-md-12">
        <h2>My Custom Create Page</h2>
     
        <form action="{{ url($crud->route) }}" method="post">
            {!! csrf_field() !!}

            @include('crud::form_content', ['fields' => $crud->getFields()])
...
<section class="header-operation container-fluid animated fadeIn d-flex mb-2 align-items-baseline d-print-none"
    ...
    <p class="ms-2 ml-2 mb-0" bp-section="page-subheading">{!! $crud->getSubheading() ?? trans('backpack::crud.add').'
        '.$crud->entity_name !!}.</p>
