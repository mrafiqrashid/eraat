...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('iera_checklists', function (Blueprint $table) {
            ...
            $table->boolean('fe_ll_question_1a_applicable')->default(0);
            $table->boolean('fe_ll_question_1b_applicable')->default(0);
            $table->boolean('fe_ll_question_2a_applicable')->default(0);
            $table->boolean('fe_ll_question_2b_applicable')->default(0);
            $table->boolean('fe_ll_question_3a_applicable')->default(0);
            $table->boolean('fe_ll_question_3b_applicable')->default(0);
            $table->boolean('fe_ll_question_4a_applicable')->default(0);
            $table->boolean('fe_ll_question_4b_applicable')->default(0);
            $table->boolean('fe_ll_question_5a_applicable')->default(0);
            $table->boolean('fe_ll_question_5b_applicable')->default(0);
